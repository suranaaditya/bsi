frappe.pages["bank-statement-importer"].on_page_load = function (wrapper) {
...
class BankStatementImporter {
    constructor(wrapper) {
        ...
        this._inject_styles();
        this.$main = $(wrapper).find(".main-section");
    ...
    _handle_file(file, $c) {
        ...
        fd.append("cmd", "uploadfile"); fd.append("csrf_token", frappe.csrf_token);
